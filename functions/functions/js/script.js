...
function getName(naam){ //In op welke regel in de HTML file wordt deze functie aangeroepen Regel 18. vul je antwoord in op de lijn
    ...
    alert(naam); //dit toont een melding op het scherm met de tekst Kris. deze tekst staan op regel 18 van de HTML vul je antwoord in op de lijn
}

function hideMe(){ //mag je de naam van de functie veranderen? Nee vul je antwoord in op de lijn
    document.getElementById("hide").style.display = "none"; 
    document.getElementById("show").style.display = "block"; 
    // wat gebeurd er in deze functie? Hij verstopt en laat het zien. en waar wordt deze in je HTML aangeroepen? Op regel 24 vul je antwoorden in op de lijn
}
...
function show(){ //als ik de naam van deze functie verander, waar verander ik deze dan in de HTML op regel 26. vul je antwoord in op de lijn
    ...
    // wat gebeurd er in deze functie? Hij verstopt hem en laat hem zien. vul je antwoord in op de lijn
}
...
function rekenen(getal){ //In op welke regel in de HTML file wordt deze functie aangeroepen regel 33. en wanneer wordt deze aangeroepen Als je op de knop klikt. vul je antwoord in op de lijn
    ...
    document.querySelector(".som").innerHTML = antwoord;  // wat doet querySelector? Hij laat het antwoord van de som zien.  Wat is antwoord hier? de waarde. vul je antwoorden in op de lijn
    
    //wat gebeurt er in deze functie? Hij rekent de som uit. vul je antwoord in op de lijn
...
function setColor(element, kleur, size){ //In op welke regel in de HTML file wordt deze functie aangeroepen. regel 39. vul je antwoord in op de lijn
    ...
    //wat gebeurt er in deze functie? Hij verandert de kleur van de tekst. vul je antwoord in op de lijn
}
